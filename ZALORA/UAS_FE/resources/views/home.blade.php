...
<body ng-app="myApp">
    ...
    <div class="gradient-wrapper">
        <img class="img-fluid full-image" src="{{ asset('IMG/IMG BG/Image1.jpg') }}" alt="Main Image" draggable="false">
        <div class="container">
    ...
    <div class="container h-auto w-100 p-3 d-flex justify-content-center align-item-center">
        <div class="card-map">
            <div class="card p-5">
                <img src="{{ asset("IMG/IMG CARD/Image1.png") }}" alt="">
            ...
            <div class="card p-5">
                <img src="{{ asset("IMG/IMG CARD/Image2.png") }}" alt="">
            ...
            <div class="card p-5">
                <img src="{{ asset("IMG/IMG CARD/Image5.png") }}" alt="">
            ...
            <div class="card p-5">
                <img src="{{ asset("IMG/IMG CARD/Image6.png") }}" alt="">
            ...
            <div class="card p-5">
                <img src="{{ asset("IMG/IMG CARD/Image7.png") }}" alt="">
            ...
            <div class="card p-5">
                <img src="{{ asset("IMG/IMG CARD/Image8.png") }}" alt="">
    ...
    <div class="container-fluid">
        <div class="container h-auto w-100 p-3 d-flex justify-content-center align-item-center flex-column">
            ...
            <video class="vidio-max rounded-3" controls>
                <source src="{{ asset("VID/Video1.mp4") }}" type="video/mp4">
